...
export default function MyLeadsPage() {
  ...
  const fetchMyLeads = async (filterValues = filters) => {
    try {
      setLoading(true);
  ...
  useEffect(() => {
    fetchMyLeads(initialFilters);
  }, []);

  const handleFilter = (event) => {
    event.preventDefault();
    fetchMyLeads(filters);
  };
    ...
    <AdminShell>
      <div className="mx-auto w-full max-w-350">
          ...
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div className="min-w-0">
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-muted md:text-base">
                View leads assigned to your account, contact them, manage
                follow-ups and update their progress.
              </p>
            </div>

            <button
              type="button"
              onClick={() => fetchMyLeads(filters)}
              disabled={loading}
        ...
        <form
          ...
          className="mb-6 grid gap-3 rounded-3xl border border-border-soft bg-white p-4 shadow-(--shadow-card) xl:grid-cols-[minmax(220px,1fr)_190px_210px_230px_auto] xl:p-5"
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-muted">
                  Leads currently assigned to your account.
                </p>
              </div>
            </div>
          ...
          {loading ? (
            ...
            <div className="flex min-h-64 flex-col items-center justify-center p-8 text-center">
              ...
              <p className="mt-2 max-w-sm text-sm leading-6 text-muted">
                No leads assigned to you match the selected filters.
              </p>
            ...
            <div className="grid grid-cols-1 gap-4 bg-bg-soft p-4 sm:p-5 md:grid-cols-2 2xl:grid-cols-3">
              {leads.map((lead) => (
                <article
                  key={lead._id}
                  className="group relative flex h-full flex-col overflow-hidden rounded-[22px] border border-border-soft bg-white p-4 shadow-(--shadow-card) transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:shadow-(--shadow-soft) sm:p-5"
                >
                  ...
                  <div className="relative flex h-full flex-col">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span
                        className={`${statusBadge(lead.leadStatus)} shrink-0`}
                      >
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-3">
                      ...
                      <div className="col-span-2 rounded-2xl border border-border-soft bg-bg-soft p-3">
